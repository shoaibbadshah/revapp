        ...
        body: SafeArea(
          child: DecoratedBox(
            ...
            child: model.loading
                ...
                : StreamProvider<BoatRideDetailModel>.value(
                    value: model.firestoreApi
                        .streamBoatRide(collectionType, rideId),
                    initialData: BoatRideDetailModel(
                      paymentType: '',
                      rideEnded: false,
                      dropLocation: '',
                      paymentStatus: '',
                    ...
                    builder: (context, child) {
                      BoatRideDetailModel boat = Provider.of(context);
                      print(boat.id);
                      return SnappingSheet(
                        ...
                        sheetBelow: SnappingSheetContent(
                          ...
                          child: Container(
                            color: Colors.white,
                            child: boat.drivers != '' || !boat.rideEnded
                                ? StreamProvider<DriverModel>.value(
                                    value: model.firestoreApi
                                        .streamDriver(boat.drivers),
