...
class KekeRide extends StatefulWidget {
  KekeRide({Key? key}) : super(key: key);

  @override
  _KekeRideState createState() => _KekeRideState();
}

class _KekeRideState extends State<KekeRide> {
...
class KekeList extends StatefulWidget {
  KekeList({
    Key? key,
  }) : super(key: key);

  @override
  _KekeListState createState() => _KekeListState();
}

class _KekeListState extends State<KekeList> {
  final _userService = locator<UserService>();
  ...
  @override
  Widget build(BuildContext context) {
    var taxis = Provider.of<List<KekeModel>>(context);
